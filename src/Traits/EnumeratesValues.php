...
use Small\Utils\Arr;
use Small\Utils\Collection;
use Small\Utils\Contract\Arrayable;
use Small\Utils\Contract\Enumerable;
use Small\Utils\Contract\Jsonable;
use Small\Utils\Proxy\HigherOrderCollectionProxy;
use Symfony\Component\VarDumper\VarDumper;
use Traversable;
use UnexpectedValueException;
use UnitEnum;

use function Small\Utils\class_basename;
use function Small\Utils\data_get;
use function Small\Utils\e;
use function Small\Utils\value;
 ...
 * @property HigherOrderCollectionProxy $Small
...
trait EnumeratesValues
{
    ...
    /**
     * Get the Small value of a given key.
     *
     * @param (callable(TValue):mixed)|string|null $callback
     *
     * @return TValue
     */
    public function Small($callback = null)
    {
        $callback = $this->valueRetriever($callback);
