...
namespace Small\Utils;

use ArrayAccess;
use ArrayIterator;
use Small\Macro\Macroable;
use Small\Utils\Contract\Arrayable;
use Small\Utils\Contract\CanBeEscapedWhenCastToString;
use Small\Utils\Contract\Enumerable;
use Small\Utils\Exception\ItemNotFoundException;
use Small\Utils\Exception\MultipleItemsFoundException;
use Small\Utils\Traits\EnumeratesValues;
use stdClass;
use Traversable;
...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
     ...
     *
     * @param array<array-key, string>|int|string $value
